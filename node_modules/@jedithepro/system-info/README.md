...
<code><h3 align="center">@jedithepro/system-info</h3></code>
...
```bash
$ npm install @jedithepro/system-info --save
```
...
`@jedithepro/system-info` will then detect this additional library and return the temperature when calling systeminformations standard function `cpuTemperature()`
